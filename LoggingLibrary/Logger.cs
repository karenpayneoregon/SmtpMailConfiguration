...
namespace LoggingLibrary 
{
    ...
    /// Karen Payne has modified from the original code
    /// </remarks>
    ...
    public sealed class LogMessageInfo : EventArgs
    {
        ...
        public bool IsError => LoggingLibrary.Logger.ERROR.Equals(Level, StringComparison.Ordinal);
        public bool IsWarning => LoggingLibrary.Logger.WARN.Equals(Level, StringComparison.Ordinal);
        public bool IsInformation => LoggingLibrary.Logger.INFO.Equals(Level, StringComparison.Ordinal);
        public bool IsDebug => LoggingLibrary.Logger.DEBUG.Equals(Level, StringComparison.Ordinal);
